...
Example setup on the control host(for someone cloning this repo):
 ...
 git clone https://github.com/manthanchoudhary20/TCOM500-Individual-Project  cd vyos-static-route-lab/ansible  python3 -m venv venv  source venv/bin/activate  pip install ansible  sudo apt update  sudo apt install -y sshpass

Bring up the VyOS lab:  cd vyos-static-route-lab/ansible  docker compose up -d  docker compose ps
...
cat outputs/before/r1_route.txt cat outputs/after/r1_route.txt
